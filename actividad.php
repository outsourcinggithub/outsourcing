 ...
 */
    ...
    class actividadPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('actividadssearch', $this->dataset,
                array('id', 'id_planificacion', 'descripcion', 'esfuerzo'),
                array($this->RenderText('Id'), $this->RenderText('Id Planificacion'), $this->RenderText('Descripcion'), $this->RenderText('Esfuerzo')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('actividadasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id', $this->RenderText('Id')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('id_planificacion', $this->RenderText('Id Planificacion')));
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('actividadGrid_descripcion_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        public function GetModalGridDeleteHandler() { return 'actividad_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'actividadGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('descripcion', 'Descripcion', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'actividadGrid_descripcion_handler_list', $column);
