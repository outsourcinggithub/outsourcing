                        ...
                        <div class="btn-group">
                            <a class="btn btn-primary"
                               ...
                               href="{$Grid.CancelUrl|escapeurl}">
                                ...
                                <span class="hidden-xs">{$Captions->GetMessageString('BackToList')}</span>
                            </a>
                        </div>
                            ...
                            <div class="btn-group">
                                <a class="btn btn-default"
                                   ...
                                   href="{$Grid.EditUrl|escapeurl}">
                                    <i class="icon-edit"></i>
                                    <span class="hidden-xs">{$Captions->GetMessageString('Edit')}</span>
                                </a>
                            </div>
                        {/if}
                        ...
                        {if count($Grid.Details) > 0}
                            <div class="btn-group">
                                <a class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#"
                                    ...
                                    <span class="hidden-xs">{$Captions->GetMessageString('ManageDetails')}</span>
                            ...
                            <div class="btn-group">
                                <a class="btn btn-default"
                                   ...
                                   title="{$Captions->GetMessageString('PrintOneRecord')}">
                                    ...
                                    <span class="hidden-xs">{$Captions->GetMessageString('PrintOneRecord')}</span>
                                </a>
                            </div>
                        {/if}
