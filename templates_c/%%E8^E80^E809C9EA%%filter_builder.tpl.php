...
<script type="text/html" id="filterBuilderConditionTemplate">
    <div class="filter-builder-condition js-condition">
        ...
        <div>
            <a href="#" class="filter-builder-condition-remove btn btn-default js-condition-remove" data-action="remove" title="<?php echo $this->_tpl_vars['Captions']->GetMessageString('RemoveCondition'); ?>
